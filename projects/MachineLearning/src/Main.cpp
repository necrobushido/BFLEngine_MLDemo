...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	//	the memory manager is incompatible with Torch apparently, so I had to remove it as a global thing
	//	tbh I probably should have been doing it case-by-case anyway, so I'll come back to it later
